...
As a teaching assistant for AP Physics C: E&amp;M during my senior year, I decided to make post AP physics worksheets on the Lagrangian formalism and a charged particle in a potential well due to a charged ring. GitHub's native PDF previewer sometimes distorts compiled LaTeX math fonts, so for the best viewing experience, I have hosted the worksheets and solutions externally: [View the worksheets and solutions here](https://drive.google.com/drive/folders/1Yj-az3sO3PaBEAiX5snnyF14qSkEwoeu?usp=sharing). The latter worksheet explores how the charged particle’s motion can be described by simple harmonic motion (SHO) when the displacement of the particle is small. Additionally, the worksheet explores the need for special relativity at high energies. 
